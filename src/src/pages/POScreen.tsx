...
const POScreen = () => {
  ...
  const totals = React.useMemo(() => {
    ...
    const balanceDue =
      total - (parseFloat(String(globalState.amountPaid)) || 0);
        ...
        <div className="flex flex-col lg:flex-row border-t border-gray-200 print-hide">
              ...
              <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
                ...
                <div className="flex flex-col sm:flex-row flex-1 gap-2 w-full">
                  ...
                  <Select
                    ...
                    onValueChange={(value) =>
                      setGlobalState({ ...globalState, paymentMode: value })
                    }
                  >
          ...
          {/* <div className="w-full lg:w-1/2 p-6 flex flex-col justify-end items-end">
               <div className="w-full max-w-xs text-center">
                 ...
                 <p className="text-xs text-gray-1000 mt-1">Authorized Signatory</p>
               </div>
